...
char Specific[Password_Length] = "1234"; // the password which is called specific in the code, change this to anything you want with the numbers 0-9 an dthe letters A-D
...
void setup()
{
  ...
  lcd.print("Smart Door"); // prints the text/charater
